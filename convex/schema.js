...
export default defineSchema({
  ...
  redemetPublishRaceReports: defineTable({
    ...
    aiswebCanonicalRawMetar: v.optional(v.string()),
    rawMetar: v.optional(v.string()),
    aiswebRawMetar: v.optional(v.string()),
    pwaRawMetar: v.optional(v.string()),
    redemetRawMetar: v.optional(v.string()),
    tgftpRawMetar: v.optional(v.string()),
    aiswebCanonicalFirstSeenAt: v.optional(v.number()),
    aiswebFirstSeenAt: v.optional(v.number()),
    pwaFirstSeenAt: v.optional(v.number()),
    redemetFirstSeenAt: v.optional(v.number()),
    redemetReceivedAt: v.optional(v.number()),
    tgftpFirstSeenAt: v.optional(v.number()),
    tgftpLastModifiedAt: v.optional(v.number()),
    winner: v.optional(
      v.union(
        v.literal("aiswebCanonical"),
        v.literal("aisweb"),
        v.literal("pwa"),
        v.literal("redemet"),
        v.literal("tgftp"),
