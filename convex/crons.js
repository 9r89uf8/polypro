...
// Retains a cadence-tagged five-minute snapshot of every AMOS display row for
// auditing and fallback; the live chart prefers the one-minute 15L series.
crons.cron(
...
// Captures immutable Weather.com daily/hourly, Google hourly (when configured),
// and Open-Meteo hourly forecasts for the RKSI 15L daily-high predictor and
// Weather.com revision diagnostics.
crons.cron(
...
// after the final 15L AMOS minutes have had time to arrive.
crons.cron(
  "seoul_15l_high_finalize_after_midnight",
  "10 15 * * *",
  internal.seoulWeather.finalizeCompletedDay,
  { stationIcao: "RKSI" },
);
