    ...
    <main className="min-h-screen px-5 py-10 md:px-8">
      <section className="mx-auto max-w-3xl rounded-3xl border border-line/80 bg-panel/90 p-8 shadow-[0_18px_50px_rgba(37,35,27,0.12)]">
        ...
        <p className="mt-4 max-w-2xl text-base leading-7 text-black/70">
          ...
          track forecast snapshots, review NZWN, Paris, Seoul, Mexico City,
          Madrid, Milan, and Ankara METAR history, and keep notes in one place.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <Link
            href="/paris/today"
            className="inline-flex items-center rounded-full border border-cyan-200 bg-cyan-50 px-5 py-2.5 text-sm font-semibold text-cyan-900 transition hover:-translate-y-0.5 hover:border-cyan-400"
          >
          ...
          <Link
            ...
            className="inline-flex items-center rounded-full border border-cyan-200 bg-cyan-50 px-5 py-2.5 text-sm font-semibold text-cyan-900 transition hover:-translate-y-0.5 hover:border-cyan-400"
          >
            Open Mexico City Airport Weather
          </Link>
          <Link
            href="/madrid/today"
          ...
          <Link
            href="/milan/today"
            className="inline-flex items-center rounded-full border border-emerald-200 bg-emerald-50 px-5 py-2.5 text-sm font-semibold text-emerald-900 transition hover:-translate-y-0.5 hover:border-emerald-400"
          >
            Open Milan METAR Logger
          </Link>
          <Link
            href="/ankara/today"
